...
mysqli_select_db($conn,"$database") or die(mysql_error($conn));
		...
		$sql="SELECT * FROM $table WHERE user_name='$temp_user' ORDER BY sl DESC";
...
{
	if($count!=$id)
	echo"<li ><a href='other_user.php?id=".$count."&ido=".$ido."'>".$count++."</a></li>";
	else
	echo"<li class='active'><a href='other_user.php?id=".$count."&ido=".$ido."'>".$count++."</a></li>";
